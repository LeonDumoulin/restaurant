...
class Reports extends Admin_Controller
{
    ...
    */
    ...
    public function storewise()
    {
        ...
        if ($this->input->post('select_year_month')) {
            $today_month1 = $this->input->post('select_year_month');
        }
        echo '<h1>'. 'الشهر الحالي المعروض: '.$today_month1.'</h1>';

        $order_data = $this->model_reports->getStoreWiseOrderData2($today_year, $today_month1, $store_id);
        $this->data['report_years'] = $this->model_reports->getOrderYear();
        $this->data['report_month'] = $this->model_reports->getOrderYear2();
