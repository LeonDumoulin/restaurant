...
class Orders extends Admin_Controller
{
    ...
    */
    public function fetchOrdersData()
    {
        ...
        foreach ($data as $key => $value) {
            $store_data = $this->model_tables->getTableData($value['table_id']);
            ...
            if (in_array('viewOrder', $this->permission)) {
                ...
                $buttons .= '<a target="__blank" href="'.base_url('orders/printDiv2/'.$value['id']).'" class="btn btn-default"><i class="fa fa-coffee"></i></a>';
            }
    ...
    */
    public function remove()
    {
        ...
        $response = array();
        if ($order_id) {
            $tid = $this->model_orders->getOrdersItemData2($order_id);
            $this->db->query("UPDATE tables SET available = 1 WHERE id = ?", $tid[0]['table_id']);
    ...
    */
    public function printDiv($id)
    {
        ...
        if ($id) {
			  ...
			  <section class="invoice">
			    ...
			    <div class="">
			      ...
			      <div style="font-size:10px" class="">
                    ...
                    <b>employee: </b> '.$this->session->userdata('username').'<br><br>
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
			    ...
			    <div class="row">
			      ...
			      <div class="">
			        ...
			        <div class="table-responsive">
			          <table style="font-size:10px;margin-left:10px;" class="table">
			            <tr>
            ...
            if ($paid_status == '1') {
                # code...$order_data['paid_amount']
                $netamount = 0;
                $allpaid = $order_data['net_amount'];
            } else {
                $allpaid = $order_data['paid_amount'];
                $netamount = $order_data['net_amount'] - $order_data['paid_amount'];
            }
            $html .=' <tr>
			              <th>Discount:</th>
			              <td>'.$discount.'</td>
                        ...
                        <tr>
                        <th>المدفوع:</th>
                        <td>'.$this->currency_code . ' ' .$allpaid.'</td>
                      </tr>
                      <tr>
                      <th>الباقي:</th>
                      <td>'.$this->currency_code . ' ' .$netamount.'</td>
                    </tr>
			            <tr>
			              <th>Paid Status:</th>
			              <td>'.$paid_status.'</td>
			        ...
			        <div class="table-responsive">
			          <table style="font-size:10px;margin-left:10px;" class="table">
			            <tr>
			              ...
			              <td>ملاحظات: '.$order_data['notes'].'</td>
			            </tr>';
