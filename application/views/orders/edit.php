                    ...
                    <div class="col-sm-7">
                      <select class="form-control" id="table_name" name="table_name">
                        <?php if ($order_data['order_table']['id']): ?>
                          <option value="<?php echo $order_data['order_table']['id']; ?>" <?php if ($order_data['order_table']['id'] == $order_data['order']['table_id']) {
    echo "selected='selected'";
} ?> ><?php echo $order_data['order_table']['table_name']; ?></option>
                        <?php endif; ?>

                        <?php foreach ($table_data as $key => $value): ?>
                          <option value="<?php echo $value['id'] ?>" <?php if ($order_data['order']['table_id'] == $value['id']) {
    echo 'selected="selected"';
    ...
    echo "selected='selected'";
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="discount" name="discount" placeholder="Discount" onkeyup="subAmount()" value="<?php echo $order_data['order']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Net Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" disabled value="<?php echo $order_data['order']['net_amount']-$order_data['order']['paid_amount'] ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">المبلغ المدفوع</label>
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="paid_amount" name="paid_amount" value="<?php echo $order_data['order']['paid_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">ملاحظات</label>
                    <div class="col-sm-9">
                      <textarea name="notes" style="min-width:100%" rows="4"><?php echo $order_data['order']['notes'] ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">اسم العميل</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="cname" value="<?php echo $order_data['order']['cname'] ?>" autocomplete="off">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >مطبخ</a>
