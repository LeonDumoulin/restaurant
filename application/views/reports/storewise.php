  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/storewise') ?>" method="POST">
            <div class="form-group">
              <label for="date">عرض التقارير لشهر</label>
              <select class="form-control" name="select_year_month" id="select_year">
                <?php foreach ($report_month as $key => $value): ?>
    ...
    echo "selected";
            ...
            <button type="submit" class="btn btn-default">اذهب</button>
          </form>
        </div>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">الرسم البيانى</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">النتائج بالارقام</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="datatables" class="table table-bordered table-striped">
                ...
                <tr>
                  <th>الشهر و اليوم</th>
                  <th>اجمالي الفواتير المدفوعة</th>
                </tr>
                </thead>
                <tbody>
